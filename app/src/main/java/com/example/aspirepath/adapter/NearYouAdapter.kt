...
class NearYouAdapter(private var institutions: List<Institution>) :
    ...
    class NearYouViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NearYouViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_institution_horizontal, parent, false)
        return NearYouViewHolder(view)
    }
